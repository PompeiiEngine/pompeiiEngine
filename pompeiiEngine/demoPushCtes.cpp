...
int main( )
{
  ...
  {
    ShaderProgram prog( "demo" );

    std::vector<uint32_t> vtx_spv = prog.addShader( R"(#version 450
    ...
    std::vector<uint32_t> frg_spv = prog.addShader( R"(#version 450
    ...
    pipelineLayout = device->createPipelineLayout(
      descriptorSetLayout, prog.pushConstantRange );
    ...
    PipelineVertexInputStateCreateInfo vertexInput( binding, prog.attributeDescriptions );
